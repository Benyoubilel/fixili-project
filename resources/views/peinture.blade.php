...
@section('scripthead')
    ...
    <!--<script>
        ...
        })(window, document, "//a.vdo.ai/core/w3layouts_V2/vdo.ai.js?vdo=34");
    </script>-->
    <div id="codefund">
        <!-- fallback content -->
    </div>
                    ...
                    <div class="col-lg-4 col-md-6 ">
                        <div class="team-item ">
                            ...
                            <div class="team-text ">
                                ...
                                <div class="mt-auto mb-3 ">
                                    <h4 class="mb-1 ">Bilel Ben Youssef</h4>
                                    <a href="/services/profile"> <span
                                            class="text-uppercase btn btn-outline-success mb-1">Voir Profile</span></a>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 ">
                        <div class="team-item ">
                            ...
                            <div class="team-text ">
                                ...
                                <div class="mt-auto mb-3 ">
                                    <h4 class="mb-1 ">Mahrez Ben Mimoun</h4>
                                    <a href="/services/profile"> <span
                                            class="text-uppercase btn btn-outline-success mb-1">Voir Profile</span></a>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 ">
                        <div class="team-item ">
                            ...
                            <div class="team-text ">
                                ...
                                <div class="mt-auto mb-3 ">
                                    <h4 class="mb-1 ">Aymen Ben yahya</h4>
                                    <a href="/services/profile"> <span
                                            class="text-uppercase btn btn-outline-success mb-1">Voir Profile</span></a>
                                </div>
                            </div>
