            ...
            <div class="container py-5 ">
                ...
                <div class="row g-3 ">
                    <div class="col-lg-4 col-md-6 ">
                        <div class="team-item ">
                            <img class="img-fluid w-100 " src="{{ asset('images/jard2.jpeg') }} " alt=" ">
                            <div class="team-text ">
                                ...
                                <div class="mt-auto mb-3 ">
                                    ...
                                    <a href="/services/jardinier"> <span
                    ...
                    <div class="col-lg-4 col-md-6 ">
                        <div class="team-item ">
                            <img class="img-fluid w-100 " src="{{ asset('images/jard3.jpeg') }} " alt=" ">
                            <div class="team-text ">
                                <div class="team-social ">
                                    <i class="bi bi-star-fill"></i>
                                    <i class="bi bi-star-fill"></i>
                                ...
                                <div class="mt-auto mb-3 ">
                                    <h4 class="mb-1 ">Taher ben ali</h4>
                                    <a href="/services/jardinier"> <span
                                            class="text-uppercase btn btn-outline-success mb-1">Voir Profile</span></a>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 ">
                        <div class="team-item ">
                            <img class="img-fluid w-100 " src="{{ asset('images/jard1.jpg') }} " alt=" ">
                            <div class="team-text ">
                                <div class="team-social ">
                                    <i class="bi bi-star-fill"></i>
                                    <i class="bi bi-star-fill"></i>
                    ...
                    <div class="col-lg-4 col-md-6 ">
                        <div class="team-item ">
                            <img class="img-fluid w-100 " src="{{ asset('images/jard4.jpeg') }} " alt=" ">
                            <div class="team-text ">
                                <div class="team-social ">
                                    <i class="bi bi-star-fill"></i>
                                    <i class="bi bi-star-fill"></i>
                    ...
                    <div class="col-lg-4 col-md-6 ">
                        <div class="team-item ">
                            <img class="img-fluid w-100 " src="{{ asset('images/jard5.jpeg') }} " alt=" ">
                    ...
                    <div class="col-lg-4 col-md-6 ">
                        <div class="team-item ">
                            <img class="img-fluid w-100 " src="{{ asset('images/jard6.jpeg') }} " alt=" ">
                            <div class="team-text ">
                                <div class="team-social ">
                                    <i class="bi bi-star-fill"></i>
                                    <i class="bi bi-star-fill"></i>
