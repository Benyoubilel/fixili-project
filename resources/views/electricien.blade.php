...
@section('scripthead')
    ...
    <!-- Template Stylesheet -->
    <link href="{{ asset('css/styleelectricien.css') }}" rel="stylesheet">
            ...
            <div class="container py-5 ">
                ...
                <div class="row g-3 ">
                    <div class="col-lg-4 col-md-6 ">
                        <div class="team-item ">
                            <img class="img-fluid w-100 " src="{{ asset('images/elec1.jpg') }} " alt=" ">
                            <div class="team-text ">
                                ...
                                <div class="mt-auto mb-3 ">
                                    <h4 class="mb-1 ">Majdi ben rjeb</h4>
                    ...
                    <div class="col-lg-4 col-md-6 ">
                        <div class="team-item ">
                            <img class="img-fluid w-100 " src="{{ asset('images/elec2.jpg') }} " alt=" ">
                            <div class="team-text ">
                                <div class="team-social ">
                                    <i class="bi bi-star-fill"></i>
                                    <i class="bi bi-star-fill"></i>
                                ...
                                <div class="mt-auto mb-3 ">
                                    <h4 class="mb-1 ">Taher bakalti</h4>
                                    <a href="/services/profile"> <span
                                            class="text-uppercase btn btn-outline-success mb-1">Voir Profile</span></a>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 ">
                        <div class="team-item ">
                            <img class="img-fluid w-100 " src="{{ asset('images/elec4.jpeg') }} " alt=" ">
                            <div class="team-text ">
                                <div class="team-social ">
                                    <i class="bi bi-star-fill"></i>
                                    <i class="bi bi-star-fill"></i>
                                ...
                                <div class="mt-auto mb-3 ">
                                    <h4 class="mb-1 ">Raouf ben ammam</h4>
                                    <a href="/services/profile"> <span
                                            class="text-uppercase btn btn-outline-success mb-1">Voir Profile</span></a>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 ">
                        <div class="team-item ">
                            <img class="img-fluid w-100 " src="{{ asset('images/elec3.jpeg') }} " alt=" ">
                            <div class="team-text ">
                                <div class="team-social ">
                                    <i class="bi bi-star-fill"></i>
                                    <i class="bi bi-star-fill"></i>
                    ...
                    <div class="col-lg-4 col-md-6 ">
                        <div class="team-item ">
                            <img class="img-fluid w-100 " src="{{ asset('images/elec5.jpeg') }} " alt=" ">
                    ...
                    <div class="col-lg-4 col-md-6 ">
                        <div class="team-item ">
                            <img class="img-fluid w-100 " src="{{ asset('images/elec6.jpeg') }}" alt=" ">
                            <div class="team-text ">
                                <div class="team-social ">
                                    <i class="bi bi-star-fill"></i>
                                    <i class="bi bi-star-fill"></i>
                                ...
                                <div class="mt-auto mb-3 ">
                                    <h4 class="mb-1 ">Aymen ben maaed</h4>
                                    <a href="/services/profile"> <span
                                            class="text-uppercase btn btn-outline-success mb-1">Voir Profile</span></a>
                                </div>
                            </div>
